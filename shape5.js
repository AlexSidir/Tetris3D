function shape5() {
  ...
  var material2 = new THREE.MeshBasicMaterial( { color: 0x808000 } );
  ...
  var material3 = new THREE.MeshBasicMaterial( { color: 0x808000 } );
  var mesh3 = new THREE.Mesh( geometry3, material3 ) ;
  mesh3.position.z =  2 * extrudeSettings.depth + 2 *extrudeSettings.bevelSize;
  group.add( mesh3);

  var geometry4 = new THREE.ExtrudeGeometry( shape, extrudeSettings );
  var material4 = new THREE.MeshBasicMaterial( { color: 0x808000 } );
