function shape5() {
  ...
  var material1 = new THREE.MeshBasicMaterial( { color: 0x69FF78 } );
  ...
  var material2 = new THREE.MeshBasicMaterial( { color: 0x69FF78 } );
  ...
  var material3 = new THREE.MeshBasicMaterial( { color: 0x69FF78 } );
  ...
  var material4 = new THREE.MeshBasicMaterial( { color: 0x69FF78 } );
