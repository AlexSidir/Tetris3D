function shape5() {
  ...
  let material1 = new THREE.MeshBasicMaterial( { color: 0x69FF78 } );
  ...
  let material2 = new THREE.MeshBasicMaterial( { color: 0x69FF78 } );
  ...
  let material3 = new THREE.MeshBasicMaterial( { color: 0x69FF78 } );
  ...
  let material4 = new THREE.MeshBasicMaterial( { color: 0x69FF78 } );
