function shape2() {
  ...
  var material1 = new THREE.MeshBasicMaterial( { color: 0xfffff } );
  ...
  var material2 = new THREE.MeshBasicMaterial( { color: 0xfffff } );
  ...
  var material3 = new THREE.MeshBasicMaterial( { color: 0xfffff } );
  ...
  var material4 = new THREE.MeshBasicMaterial( { color: 0xfffff } );
