function shape2() {
  ...
  let material1 = new THREE.MeshBasicMaterial( { color: 0xfffff } );
  ...
  let material2 = new THREE.MeshBasicMaterial( { color: 0xfffff } );
  let mesh2 = new THREE.Mesh( geometry2, material2 ) ;
  mesh2.position.x = extrudeSettings.depth + 3 * extrudeSettings.bevelSize;
  mesh2.position.z = extrudeSettings.bevelSize;
  group.add( mesh2 );

  let geometry3 = new THREE.ExtrudeGeometry( shape, extrudeSettings );
  let material3 = new THREE.MeshBasicMaterial( { color: 0xfffff } );
  let mesh3 = new THREE.Mesh( geometry3, material3 ) ;
  mesh3.position.z = extrudeSettings.depth +  3 * extrudeSettings.bevelSize;
  mesh3.position.x = extrudeSettings.bevelSize;
  group.add( mesh3 );

  let geometry4 = new THREE.ExtrudeGeometry( shape, extrudeSettings );
  let material4 = new THREE.MeshBasicMaterial( { color: 0xfffff } );
  let mesh4 = new THREE.Mesh( geometry4, material4 ) ;
  mesh4.position.z = extrudeSettings.depth + 3 * extrudeSettings.bevelSize;
  mesh4.position.x = extrudeSettings.depth + 3 * extrudeSettings.bevelSize;
  group.add( mesh4 );
  ...
  let line4 = new THREE.LineSegments( wireframe3 );
