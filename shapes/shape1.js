function shape1() {
  ...
  mesh2.position.z = extrudeSettings.depth + 2 * extrudeSettings.bevelSize + extrudeSettings.bevelSize;
  ...
  mesh3.position.z = 2 * extrudeSettings.depth + 3 * extrudeSettings.bevelSize + 2 * extrudeSettings.bevelSize;
  mesh3.position.x = extrudeSettings.bevelSize;
  group.add( mesh3);

  let geometry4 = new THREE.ExtrudeGeometry( shape, extrudeSettings );
  let material4 = new THREE.MeshBasicMaterial( { color: 0xFF0000 } );
  let mesh4 = new THREE.Mesh( geometry4, material4 ) ;
  mesh4.position.z = 3 * extrudeSettings.depth + 4 * extrudeSettings.bevelSize + 3 * extrudeSettings.bevelSize;
  mesh4.position.x = extrudeSettings.bevelSize;
  group.add( mesh4);
